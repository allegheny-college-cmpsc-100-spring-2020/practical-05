...
If it's true that our `object` syntax is `{Type} {Identifier} = new {Object}(arguments)`, then if I tell you that, overnight, our installation of Java sprouted the ability to create `Die` type objects **_without importing random_**, would the following work:
